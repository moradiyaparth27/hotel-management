...
Label(sroot,text="Parth Moradiya",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
Label(sroot,text="moradiyaparth3@gmail.com",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=270)
...
def mainroot():
	...
	root.title("Made with love by parth")
	#--------------seperator-------------------------------------------------------------------------------------------------------------------
